...
}cP+=b5[cG][ca].index+1;return cP;}function cD(cR){if(cR!=undefined){ca=cy(cR).page;cG=cy(cR).section;}var cQ="";var cO=cA[cG];cQ+=W(cO);if(b5[cG].length>0){var cP=b5[cG][ca];
